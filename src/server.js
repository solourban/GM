...
app.get('/', (req, res, next) => {
  fs.readFile(path.join(PUBLIC_DIR, 'index.html'), 'utf8', (err, html) => {
    ...
    let patched = html;
    const scripts = ['/gm-core-patch.js', '/patch-registry-patch.js', '/landing-polish-patch.js', '/card-width-polish-patch.js', '/platform-patch.js', '/address-fix.js', '/watchlist-patch.js', '/watchlist-enhance-patch.js', '/today-dashboard-patch.js', '/date-recommendations-patch.js', '/stepflow-patch.js', '/fetch-error-patch.js', '/court-list-patch.js', '/bulk-fetch-patch.js', '/map-patch.js', '/molit-patch.js', '/molit-fallback-patch.js', '/molit-scenario-patch.js', '/capital-patch.js', '/cashflow-patch.js', '/stability-patch.js', '/diagnostics-patch.js', '/exit-plan-patch.js', '/bid-checklist-patch.js', '/final-summary-patch.js', '/api-guide-patch.js'];
    scripts.forEach((src) => {
