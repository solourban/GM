(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .site-header { position: sticky; top: 0; z-index: 100; background: rgba(246,245,241,.96); backdrop-filter: blur(10px); border-bottom:1px solid var(--line); max-width:100%; overflow-x:hidden; }
      .header-inner { width:100%; min-width:0; min-height:82px; display:flex; justify-content:space-between; gap:20px; align-items:center; }
      .brand { cursor:pointer; text-decoration:none; min-width:0; max-width:100%; }
      .brand-text { min-width:0; }
      .brand-text h1, .brand-text p { overflow-wrap:anywhere; }
      .v2-tabs { display:flex; gap:8px; flex-wrap:wrap; justify-content:flex-end; max-width:100%; min-width:0; }
      .v2-tab { min-width:0; max-width:100%; border:1px solid var(--line); background:#fff; color:var(--ink-2); border-radius:999px; padding:9px 14px; font-size:13px; font-weight:900; cursor:pointer; white-space:nowrap; overflow-wrap:anywhere; }
