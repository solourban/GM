...
const required = [
  ...
  [displayFix, 'function markBidCard', 'bid card workflow marker'],
  [displayFix, 'function setCardHtml', 'bid card no-op render guard'],
  [displayFix, 'card.dataset.signature === signature', 'bid card signature no-op'],
  [displayFix, "markBidCard(card, 'v2-bidding-summary-card')", 'bidding summary marker'],
  [displayFix, "markBidCard(card, 'v2-bid-range-card')", 'bid range marker'],
  [displayFix, "markBidCard(card, 'v2-funding-review-card')", 'funding review marker'],
  [displayFix, "markBidCard(card, 'v2-pre-bid-checklist-card')", 'pre-bid checklist marker'],
  [bidPlan, "card.className = 'v2-result-card v2-bid-plan-card'", 'bid plan result card marker'],
  [bidPlan, "card.dataset.workflowStep = 'bid'", 'bid plan workflow marker'],
