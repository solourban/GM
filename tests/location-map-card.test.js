...
const required = [
  ...
  [script, 'MAP_RELAYOUT_SERIES_DELAYS', 'Kakao relayout stabilization cadence'],
  ...
  [script, 'function mapHasVisibleBox', 'visible map box guard before relayout'],
  [script, 'function relayoutMapTarget', 'single map target relayout helper'],
  [script, "stabilizeMapTarget(target, 'manual-button')", 'manual relayout button handler'],
  [script, 'function stabilizeMapTarget', 'Kakao map stabilization helper'],
  [script, '지도 자동 재정렬', 'visible map auto-stabilization status'],
  [script, '지도 영역 대기', 'hidden map area waiting status'],
  [script, 'IntersectionObserver', 'map visibility relayout observer'],
  [script, 'intersection-visible', 'map visible relayout reason'],
  [script, 'function scheduleVisibleMapRelayout', 'visible map relayout scheduler'],
  [script, "window.addEventListener('orientationchange'", 'orientation change map relayout'],
  [script, "window.addEventListener('scroll'", 'scroll map relayout recovery'],
  [script, 'relayoutTarget: relayoutMapTarget', 'debug bridge target relayout helper'],
  [script, 'stabilizeTarget: stabilizeMapTarget', 'debug bridge map stabilization helper'],
  [script, 'relayoutVisible: relayoutVisibleKakaoMaps', 'debug bridge visible map relayout helper'],
